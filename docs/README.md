...
| [phases-ui.md](phases-ui.md) | **Product/UI phases** U1–U5: menus, timeline, export UX, polish, AI (table + detail). |
| [phase-status.md](phase-status.md) | **Engineering phases** 0–4 + doc milestones (infra, player, sidecar, bundled docs). |
